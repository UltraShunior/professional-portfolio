...
const page = () => {
  const counterItems = [
    ...
    { id: 2, title: "Project Completed", value: 13 },
    { id: 3, title: "Happy Clients", value: 9 },
  ];
  // TODO: Extract the bio from the json file
  const about = {
    name: "Nahuel Bogado",
    bio: " A Passionate <b>Full Stack Developer</b> 🖥️ &amp; <b>Web Designer</b> having <b>+2 years </b> of Experiences over 4 Country Worldwide.",
  };

  return (
    <BentoFolioLayout>
      <div className="col-xl-8">
        <div className="card content-box-card bg-blur">
