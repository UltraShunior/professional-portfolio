...
const Awards = () => {
  // TODO: Add awards data from the JSON file
  const awardItems = [
    {
      id: 2,
      icon: "/assets/img/icons/dribbble.svg",
      title: "Fiverr x Dager challenge",
      date: "2022 - 2023",
      award: "Project tier S",
      link: "https://www.youtube.com/live/d_FfOla6mfw?feature=shared&t=15945",
    },
    {
      id: 1,
      ...
      date: "2022",
      award: "Best Student",
      link: "https://www.linkedin.com/in/nawedev/",
    },
  ];
  return (
    <div className="awards-recognitions">
      <h2 className="main-common-title">Titles and Recognitions</h2>
            ...
            <li key={item.id}>
                <div className="awards-item">
                  <div className="award-name">
                    <div className="icon">
                      <Image src={item.icon} alt="behance" width={40} height={40} />
                    </div>
                    <div className="text">
